        ...
        <section>
          <span>
            ...
            <ul className="value-list">
              <li>
                {" "}
                <strong>Commitment</strong>- We are dedicated to changing lives.
              </li>
              <li>
                <strong>Compassion</strong>- We are guided by empathy.
              </li>
              <li>
                <strong>Collaboration</strong>- We are best when united.
              </li>
              <li>
                <strong>Conscientiousness</strong> - We are best when we are
                diligent.
              </li>
            </ul>
          </span>
